...
const SYSTEM_PROMPT = `You are an investigator analyzing GitHub user profiles to detect accounts likely used for AI slop spam, reputation farming, or supply-chain attacks.
